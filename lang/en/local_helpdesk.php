...
$string['replyconfirmsend'] = 'Send as an additional reply';
$string['replyconfirmreview'] = 'Review latest ticket';
$string['replyconflictdraftmessage'] = 'Your message to send';
$string['replyconflictmessage'] = 'A newer reply from the same side has already been added. Please review the latest ticket content before sending, or send your message as an additional reply.';
